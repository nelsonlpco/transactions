...
// Source: ./infrastructure/datasource/operationtype_datasource.go
...
func (m *MockOperationTypeDatasource) GetById(ctx context.Context, id []byte) (*inframodel.OperationTypeModel, error) {
	m.ctrl.T.Helper()
